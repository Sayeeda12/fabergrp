...
class FileProcessorServiceTest {
    ...
    void testReadFileAndGetCommands() throws IOException {
        ...
        List<Operation> result = FileProcessorService.readFileAndGetCommands("localFile", filePath);
    ...
    void testReadFileAndGetCommandsWithInvalidInput() {
        ...
        assertThrows(WaterBillGenerationException.class, () -> FileProcessorService.readFileAndGetCommands("localFile", filePath));
    }
    ...
    @Test
    void testReadFileAndGetCommandsWithInvalidInputArg() throws IOException {
        String filePath = "test-files/test.txt";
        ...
        List<Operation> result = FileProcessorService.readFileAndGetCommands("invalidInputFile", filePath);
    ...
    @Test
    void testReadFileAndGetCommandsWithURL() throws IOException {
        String filePath = "https://raw.githubusercontent.com/Sayeeda12/fabergrp/master/io/test.txt";
        List<Operation> operationList = new ArrayList<>();
        operationList.add(new Operation(Command.ALLOT_WATER, Arrays.asList("2", "3:7")));
        operationList.add(new Operation(Command.ADD_GUESTS, Collections.singletonList("2")));
        operationList.add(new Operation(Command.ADD_GUESTS, Collections.singletonList("3")));
        operationList.add(new Operation(Command.BILL, Collections.emptyList()));

        List<Operation> result = FileProcessorService.readFileAndGetCommands("URL", filePath);
        assertEquals(operationList.get(0).getCommand(), result.get(0).getCommand());
        assertEquals(operationList.get(0).getCommandArgs().get(0), result.get(0).getCommandArgs().get(0));
        assertEquals(operationList.get(0).getCommandArgs().get(1), result.get(0).getCommandArgs().get(1));
        assertEquals(operationList.get(1).getCommandArgs().get(0), result.get(1).getCommandArgs().get(0));
    ...
    @Test
    void testReadFileAndGetCommandsWithInvalidURL() {
        String filePath = "https://raw.githubusercontent.com/Sayeeda12/fabergrp/master/io/test1.txt";
        assertThrows(WaterBillGenerationException.class, () -> FileProcessorService.readFileAndGetCommands("URL", filePath));
    }

    @Test
    void testReadFileAndGetCommandsWithInvalidURL1() {
        String filePath = "test-files/test1.txt";
        assertThrows(WaterBillGenerationException.class, () -> FileProcessorService.readFileAndGetCommands("URL", filePath));
    }
}